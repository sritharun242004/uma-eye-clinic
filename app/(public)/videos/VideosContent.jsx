...
const videos = [
  ...
  // Videos with local thumbnails (YouTube IDs not available via RSS)
  { id: 16, title: 'SMILE Pro Laser for Glass-Free Vision', category: 'smile-pro', description: 'Patient shares their journey from relying on glasses to SMILE Pro for improved vision.', thumb: '/images/media/thumb/smile-pro-8.webp' },
  ...
  { id: 18, title: '1000 SMILE PRO Laser Procedures Milestone', category: 'smile-pro', description: 'Celebrating 1000 completed SMILE PRO procedures at Uma Eye Clinic.', thumb: '/images/media/thumb/1000-smile.webp' },
  { id: 19, title: 'LASIK For Age 40 and Above - Presbyond', category: 'presbyond', description: 'Designed for those aged 40 and above, achieving clear glass-free vision without reading glasses.', thumb: '/images/media/thumb/presbyond.webp' },
  ...
  { id: 22, title: 'Actress Farina Azad - SMILE PRO Treatment', category: 'patient-stories', description: 'Celebrity testimonial highlighting minimally invasive SMILE PRO with quick recovery.', thumb: '/images/media/thumb/farina-azad.webp' },
  ...
  { id: 24, title: 'SMILE Pro Live Procedure Demonstration', category: 'smile-pro', description: 'Live procedure at Madras City Ophthalmic Association - painless, just a few minutes.', thumb: '/images/media/thumb/live-procedure.webp' },
